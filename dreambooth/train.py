...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        # self.instance_prompt = "in Impressionist style, with a texture of Thick Brushstrokes and Vibrant Colors."
...
def main(args):
    ...
    text_encoder = text_encoder_cls.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="text_encoder", revision=args.revision, proxies=proxies,
        cache_dir=cached_path,
    )
    vae = AutoencoderKL.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="vae", revision=args.revision, proxies=proxies,
        cache_dir=cached_path,
    )

    unet = UNet2DConditionModel.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="unet", revision=args.revision, proxies=proxies,
        cache_dir=cached_path,
    )
